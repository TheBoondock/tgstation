...
/datum/status_effect/inebriated/drunk/proc/attempt_to_blackout()
	...
	// If they already have the trauma black them out, if they dont and can get it then give them the trauma
	if(drunkard.has_trauma_type(/datum/brain_trauma/severe/split_personality/blackout) && prob(10))
